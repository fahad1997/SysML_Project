...
#include "SMSWTD.h"
//#[ ignore
#define SMSWTD_SYSTEM_ANALYSIS_User_User_SERIALIZE OM_NO_OP
//#]
...
User::User(void) : itsSMSWTD(NULL) {
    NOTIFY_CONSTRUCTOR(User, User(), 0, SMSWTD_SYSTEM_ANALYSIS_User_User_SERIALIZE);
}
...
IMPLEMENT_META_P(User, SMSWTD_SYSTEM_ANALYSIS, SMSWTD_SYSTEM::ANALYSIS, false, OMAnimatedUser)
#endif // _OMINSTRUMENT
